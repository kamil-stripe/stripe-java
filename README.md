...
```groovy
implementation "com.stripe:stripe-java:21.2.1"
```
...
- [The Stripe JAR](https://search.maven.org/remotecontent?filepath=com/stripe/stripe-java/21.2.1/stripe-java-21.2.1.jar)
