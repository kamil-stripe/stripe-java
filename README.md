...
```groovy
implementation "com.stripe:stripe-java:21.2.2"
```
...
- [The Stripe JAR](https://search.maven.org/remotecontent?filepath=com/stripe/stripe-java/21.2.2/stripe-java-21.2.2.jar)
